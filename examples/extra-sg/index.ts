...
const ngInstanceProfile = new aws.iam.InstanceProfile(
  "example-instanceProfile",
  { role: ngRole }
);
...
const nodeIngressRule = new aws.ec2.SecurityGroupRule("nodeIngressRule", {
  description:
    "Allow all ingress into the worker nodes from the security group",
  type: "ingress",
  fromPort: 0,
  toPort: 65535,
  protocol: "tcp",
...
const publicInternetHttpIngressRule = new aws.ec2.SecurityGroupRule(
  "internetHttpEgressRule",
  {
...
const publicInternetEgressRule = new aws.ec2.SecurityGroupRule(
  "nodeIternetEgressRule",
  {
