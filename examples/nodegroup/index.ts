...
export = async () => {
    ...
    new eks.NodeGroup("example-ng-simple-ondemand", {
        cluster: pulumi.output(cluster1),
    ...
    }, { parent: cluster1, providers: [await cluster1.getK8sProvider()]  });
    ...
    const spot = new eks.NodeGroup("example-ng-simple-spot", {
        ...
        providers: { kubernetes: await cluster1.getK8sProvider() },
    });
    ...
    * role and profile.
    ...
    }, { providers: { kubernetes: await cluster2.getK8sProvider() } });
