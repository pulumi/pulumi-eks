...
export = async () => {
    ...
    const urn = await cluster1.getK8sProviderUrn();
    console.error('URN: ', urn);
    const provider = await cluster1.getK8sProvider();
    console.log('HERE!!: ', provider);

    new k8s.core.v1.Namespace("apps", undefined, {provider: urn.result});
