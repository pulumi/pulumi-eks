...
class ClusterArgs:
    def __init__(__self__, *,
                 access_entries: Optional[Mapping[str, pulumi.Input['AccessEntryArgs']]] = None,
                 ...
                 storage_classes: Optional[Union[pulumi.Input[str], Mapping[str, pulumi.Input['StorageClassArgs']]]] = None,
        ...
        :param Mapping[str, pulumi.Input['AccessEntryArgs']] access_entries: Access entries to add to the EKS cluster. They can be used to allow IAM principals to access the cluster. Access entries are only supported with authentication mode `API` or `API_AND_CONFIG_MAP`.
        ...
        :param Union[pulumi.Input[str], Mapping[str, pulumi.Input['StorageClassArgs']]] storage_classes: An optional set of StorageClasses to enable for the cluster. If this is a single volume type rather than a map, a single StorageClass will be created for that volume type.
    ...
    def access_entries(self) -> Optional[Mapping[str, pulumi.Input['AccessEntryArgs']]]:
        """
    ...
    def access_entries(self, value: Optional[Mapping[str, pulumi.Input['AccessEntryArgs']]]):
    ...
    def storage_classes(self) -> Optional[Union[pulumi.Input[str], Mapping[str, pulumi.Input['StorageClassArgs']]]]:
        """
    ...
    def storage_classes(self, value: Optional[Union[pulumi.Input[str], Mapping[str, pulumi.Input['StorageClassArgs']]]]):
...
class Cluster(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 access_entries: Optional[Mapping[str, pulumi.Input[Union['AccessEntryArgs', 'AccessEntryArgsDict']]]] = None,
                 authentication_mode: Optional['AuthenticationMode'] = None,
                 cluster_security_group: Optional[pulumi.Input['pulumi_aws.ec2.SecurityGroup']] = None,
                 cluster_security_group_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 cluster_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 ...
                 service_role: Optional[pulumi.Input['pulumi_aws.iam.Role']] = None,
                 skip_default_node_group: Optional[bool] = None,
                 storage_classes: Optional[Union[pulumi.Input[str], Mapping[str, pulumi.Input[Union['StorageClassArgs', 'StorageClassArgsDict']]]]] = None,
                 subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 use_default_vpc_cni: Optional[bool] = None,
        ...
        :param Mapping[str, pulumi.Input[Union['AccessEntryArgs', 'AccessEntryArgsDict']]] access_entries: Access entries to add to the EKS cluster. They can be used to allow IAM principals to access the cluster. Access entries are only supported with authentication mode `API` or `API_AND_CONFIG_MAP`.
        ...
        :param pulumi.Input['pulumi_aws.iam.Role'] service_role: IAM Service Role for EKS to use to manage the cluster.
        :param bool skip_default_node_group: If this toggle is set to true, the EKS cluster will be created without node group attached. Defaults to false, unless `fargate` input is provided.
        :param Union[pulumi.Input[str], Mapping[str, pulumi.Input[Union['StorageClassArgs', 'StorageClassArgsDict']]]] storage_classes: An optional set of StorageClasses to enable for the cluster. If this is a single volume type rather than a map, a single StorageClass will be created for that volume type.
