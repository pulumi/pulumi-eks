...
class NodeGroupSecurityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_id: The VPC in which to create the worker node group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value mapping of tags to apply to this security group.
        """
