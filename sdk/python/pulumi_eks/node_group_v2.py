...
class NodeGroupV2Args:
    def __init__(__self__, *,
                 ...
                 labels: Optional[Mapping[str, pulumi.Input[str]]] = None,
                 ...
                 taints: Optional[Mapping[str, pulumi.Input['TaintArgs']]] = None,
        ...
        :param Mapping[str, pulumi.Input[str]] labels: Custom k8s node labels to be attached to each worker node. Adds the given key/value pairs to the `--node-labels` kubelet argument.
        ...
        :param Mapping[str, pulumi.Input['TaintArgs']] taints: Custom k8s node taints to be attached to each worker node. Adds the given taints to the `--register-with-taints` kubelet argument
    ...
    @property
    @pulumi.getter
    def labels(self) -> Optional[Mapping[str, pulumi.Input[str]]]:
        """
    ...
    @labels.setter
    def labels(self, value: Optional[Mapping[str, pulumi.Input[str]]]):
    ...
    @property
    @pulumi.getter
    def taints(self) -> Optional[Mapping[str, pulumi.Input['TaintArgs']]]:
        """
    ...
    @taints.setter
    def taints(self, value: Optional[Mapping[str, pulumi.Input['TaintArgs']]]):
...
class NodeGroupV2(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 node_user_data_override: Optional[pulumi.Input[str]] = None,
                 spot_price: Optional[pulumi.Input[str]] = None,
                 taints: Optional[Mapping[str, pulumi.Input[Union['TaintArgs', 'TaintArgsDict']]]] = None,
                 version: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] node_user_data_override: User specified code to run on node startup. This code is expected to handle the full AWS EKS bootstrapping code and signal node readiness to the managing CloudFormation stack. This code must be a complete and executable user data script in bash (Linux) or powershell (Windows).
               ...
               See for more details: https://docs.aws.amazon.com/eks/latest/userguide/worker.html
        :param pulumi.Input[str] spot_price: Bidding price for spot instance. If set, only spot instances will be added as worker node.
        :param Mapping[str, pulumi.Input[Union['TaintArgs', 'TaintArgsDict']]] taints: Custom k8s node taints to be attached to each worker node. Adds the given taints to the `--register-with-taints` kubelet argument
        :param pulumi.Input[str] version: Desired Kubernetes master / control plane version. If you do not specify a value, the latest available version is used.
        """
        ...
    @overload
