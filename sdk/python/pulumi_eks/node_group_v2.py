...
class NodeGroupV2Args:
    def __init__(__self__, *,
        ...
        NodeGroupV2Args._configure(
            ...
            labels=labels,
            launch_template_tag_specifications=launch_template_tag_specifications,
            max_size=max_size,
            min_refresh_percentage=min_refresh_percentage,
            min_size=min_size,
    ...
    def _configure(
        ...
        if launch_template_tag_specifications is not None:
            _setter("launch_template_tag_specifications", launch_template_tag_specifications)
        if max_size is not None:
            _setter("max_size", max_size)
        if min_refresh_percentage is not None:
            _setter("min_refresh_percentage", min_refresh_percentage)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            NodeGroupV2Args._configure(_setter, **kwargs)
