...
class NodeGroupV2(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 bottlerocket_settings: pulumi.Input[Optional[Mapping[str, Any]]] = None,
                 cloud_formation_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 cluster: pulumi.Input[Optional[Union['Cluster', Union['CoreDataArgs', 'CoreDataArgsDict', 'outputs.CoreData']]]] = None,
                 cluster_ingress_rule: pulumi.Input[Optional['pulumi_aws.ec2.SecurityGroupRule']] = None,
                 cluster_ingress_rule_id: pulumi.Input[Optional[_builtins.str]] = None,
                 desired_capacity: pulumi.Input[Optional[_builtins.int]] = None,
                 enable_detailed_monitoring: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 kubelet_extra_args: pulumi.Input[Optional[_builtins.str]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 launch_template_tag_specifications: pulumi.Input[Optional[Sequence[pulumi.Input[pulumi.InputType['pulumi_aws.ec2.LaunchTemplateTagSpecificationArgs']]]]] = None,
                 max_size: pulumi.Input[Optional[_builtins.int]] = None,
                 min_refresh_percentage: pulumi.Input[Optional[_builtins.int]] = None,
                 min_size: pulumi.Input[Optional[_builtins.int]] = None,
                 node_associate_public_ip_address: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 node_user_data: pulumi.Input[Optional[_builtins.str]] = None,
                 node_user_data_override: pulumi.Input[Optional[_builtins.str]] = None,
                 nodeadm_extra_options: pulumi.Input[Optional[Sequence[pulumi.Input[Union['NodeadmOptionsArgs', 'NodeadmOptionsArgsDict', 'outputs.NodeadmOptions']]]]] = None,
                 operating_system: pulumi.Input[Optional['OperatingSystem']] = None,
                 spot_price: pulumi.Input[Optional[_builtins.str]] = None,
                 taints: pulumi.Input[Optional[Mapping[str, pulumi.Input[Union['TaintArgs', 'TaintArgsDict', 'outputs.Taint']]]]] = None,
                 version: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] cloud_formation_tags: The tags to apply to the CloudFormation Stack of the Worker NodeGroup.
               ...
               Note: Given the inheritance of auto-generated CF tags and `cloudFormationTags`, you should either supply the tag in `autoScalingGroupTags` or `cloudFormationTags`, but not both.
        :param pulumi.Input[Union['Cluster', Union['CoreDataArgs', 'CoreDataArgsDict', 'outputs.CoreData']]] cluster: The target EKS cluster.
        :param pulumi.Input['pulumi_aws.ec2.SecurityGroupRule'] cluster_ingress_rule: The ingress rule that gives node group access.
        :param pulumi.Input[_builtins.str] cluster_ingress_rule_id: The ID of the ingress rule that gives node group access.
        :param pulumi.Input[_builtins.int] desired_capacity: The number of worker nodes that should be running in the cluster. Defaults to 2.
        :param pulumi.Input[_builtins.bool] enable_detailed_monitoring: Enables/disables detailed monitoring of the EC2 instances.
        ...
        :param pulumi.Input['OperatingSystem'] operating_system: The type of OS to use for the node group. Will be used to determine the right EKS optimized AMI to use based on the instance types and gpu configuration.
               ...
               Defaults to the current recommended OS.
        :param pulumi.Input[_builtins.str] spot_price: Bidding price for spot instance. If set, only spot instances will be added as worker node.
        :param pulumi.Input[Mapping[str, pulumi.Input[Union['TaintArgs', 'TaintArgsDict', 'outputs.Taint']]]] taints: Custom k8s node taints to be attached to each worker node. Adds the given taints to the `--register-with-taints` kubelet argument
        :param pulumi.Input[_builtins.str] version: Desired Kubernetes master / control plane version. If you do not specify a value, the latest available version is used.
        """
        ...
    @overload
