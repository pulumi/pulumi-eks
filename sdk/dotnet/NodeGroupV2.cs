...
namespace Pulumi.Eks
{
    ...
    /// </summary>
    [EksResourceType("eks:index:NodeGroupV2")]
    public partial class NodeGroupV2 : global::Pulumi.ComponentResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("extraNodeSecurityGroups")]
        ...
        public NodeGroupV2(string name, NodeGroupV2Args args, ComponentResourceOptions? options = null)
            : base("eks:index:NodeGroupV2", name, args ?? new NodeGroupV2Args(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class NodeGroupV2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public NodeGroupV2Args()
        {
        }
        public static new NodeGroupV2Args Empty => new NodeGroupV2Args();
    }
}
