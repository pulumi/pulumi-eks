...
namespace Pulumi.Eks
{
    ...
    public partial class NodeGroup : Pulumi.ComponentResource
    {
        /// <summary>
        ...
        public NodeGroup(string name, NodeGroupArgs args, ComponentResourceOptions? options = null)
            : base("eks:index:NodeGroup", name, args ?? new NodeGroupArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
