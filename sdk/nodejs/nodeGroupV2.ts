...
export class NodeGroupV2 extends pulumi.ComponentResource {
     ...
     */
    declare public /*out*/ readonly autoScalingGroup: pulumi.Output<pulumiAws.autoscaling.Group>;
    /**
    ...
    constructor(name: string, args: NodeGroupV2Args, opts?: pulumi.ComponentResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["launchTemplateTagSpecifications"] = args?.launchTemplateTagSpecifications;
            resourceInputs["maxSize"] = args?.maxSize;
            resourceInputs["minRefreshPercentage"] = args?.minRefreshPercentage;
